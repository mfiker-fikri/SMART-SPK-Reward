        ...
        <div class="col-xxl">
            ...
            <div class="card mx-4">
                ...
                <div class="card-body py-xl-5 py-sm-5 px-xl-5">
                    ...
                    <form id="formCreateHWUNew" class="mx-2" method="POST" action="{{ route('admin.postManageHWU.Create.Admin') }}" enctype="multipart/form-data">
                        @csrf
                        <!-- Full Name -->
                        ...
                        <div class="mt-4 d-flex justify-content-end">
                            <div class="justify-content-between">
                                <a class="btn btn-secondary btn-lg" href="{{ URL::to('admin/manage/headworkunit') }}" role="button" style="color: black">
