    ...
    <div class="container px-sm-1 d-flex flex-row align-items-center" id="navbar-collapse">
        ...
        <ol class="breadcrumb breadcrumb-style1 my-lg-3 my-3">
            ...
            @elseif ( request()->is('ksk/form-innovation/list') )
                ...
                <li class="breadcrumb-item fw-bold active">Verifikasi Formulir Penghargaan Inovasi Pegawai</li>
            ...
            @elseif ( request()->is('ksk/form-innovation/list/update*') )
                ...
                <li class="breadcrumb-item fw-light">
                    <a href="{{ URL::to('/ksk/form-innovation/list') }}" style="text-decoration: none !important;">Verifikasi Formulir Penghargaan Inovasi Pegawai</a>
                </li>
