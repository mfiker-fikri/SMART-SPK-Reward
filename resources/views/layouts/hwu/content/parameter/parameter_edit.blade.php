    ...
    <div class="row mt-3">
        ...
        <div class="col-xxl">
            ...
            <div class="card mx-4">
                ...
                <!-- Form Update Parameter Title -->
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">Lihat Parameter</h5>
                </div>
                <!--/ Form Update Parameter Title -->

                <!-- Form Update Parameter New -->
                <div class="card-body py-xl-5 py-sm-5 px-xl-5">

                    <form id="formViewParameters" class="mx-2" method="POST" action="#">
                        @csrf
                        <!-- Categories -->
                        ...
                        <div class="mb-3 row {{ $errors->has('parameters') ? 'is-invalid' : '' }}">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group input-group-merge {{ $errors->has('parameters') ? 'is-invalid' : '' }}">
                        ...
                        <div class="mb-3 row {{ $errors->has('grades') ? 'is-invalid' : '' }}">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group input-group-merge {{ $errors->has('grades') ? 'is-invalid' : '' }}">
                        ...
                        <div class="d-flex justify-content-end">
                            <div class="justify-content-between">
                                <a class="btn btn-primary btn-lg" href="{{ URL::to('hrd/manage/parameters') }}" role="button" style="color: black">
