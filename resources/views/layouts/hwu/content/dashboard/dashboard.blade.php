            ...
            <div class="card mb-2 visible shadow-lg d-flex justify-content-center align-self-center cardInovation">
                <div class="d-flex justify-content-center align-self-center cardFormInovation">
                    ...
                    @else
                        @if (
                            (
                                ($timerInovasi->status_open == 0 && $timerInovasi->date_time_open_form_innovation >= \Carbon\Carbon::now()->toDateTimeString()  ) && ($timerInovasi->status_expired == 0 && \Carbon\Carbon::now()->toDateTimeString() <= $timerInovasi->date_time_expired_form_innovation )
                            )
                            ||
                            (
                                ($timerInovasi->status_open == 0 && $timerInovasi->date_time_open_form_innovation >= \Carbon\Carbon::now()->toDateTimeString() ) && ($timerInovasi->status_expired == 1 && \Carbon\Carbon::now()->toDateTimeString() <= $timerInovasi->date_time_expired_form_innovation )
                            )
                        )
                        ...
                        <div class="container-fluid swiper1">
                            <div class="openTimerCountDown swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="wrap-countdown countdown-TA-inovation" data-expire="{{ \Carbon\Carbon::parse($timerInovasi->date_time_open_form_innovation)->toDateTimeString() }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="container-fluid swiper1_1">
                            <div class="openTimerCountDown swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="wrap-countdown countdown-TA-inovation-closed" data-expire="{{ \Carbon\Carbon::parse($timerInovasi->date_time_expired_form_innovation)->toDateTimeString() }}">
                                    </div>
                                </div>
                            </div>
                        </div>
