            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="app-brand justify-content-center">
                        <a href="{{ URL::to('/penilai') }}" class="app-brand-link gap-2">
                    ...
                    <!-- Form Login -->
                    <form id="formTALogin" class="mb-3 mx-3" method="POST" action="{{ URL::to('/penilai') }}" >
                        @csrf
                        ...
                        <div class="mb-3 form-password-toggle">
                            <div class="d-flex justify-content-between">
                                ...
                                <a href="{{ URL::to('/penilai/forgot-password') }}">
