            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="app-brand justify-content-center">
                        <a href="{{ URL::to('/penilai/reset-password*') }}" class="app-brand-link gap-2">
                    ...
                    <!-- Reset Password -->
                    <form id="formTAResetPassword" class="mb-3 mx-3" method="POST" action="{{ route('penilai.postResetPassword.Penilai') }}">
                        @csrf
