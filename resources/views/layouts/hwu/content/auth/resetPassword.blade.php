            ...
            $(".expiredDate").each( function(){
                ...
                .on('finish.countdown', function(){
                    Swal.fire({
                        ...
                        didClose: () => {
                            window.location = "/ksk/forgot-password";
                        },
                    });
                });
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="app-brand justify-content-center">
                        <a href="{{ URL::to('/headworkunit/reset-password*') }}" class="app-brand-link gap-2">
                    ...
                    <!-- Reset Password -->
                    <form id="formAdminResetPassword" class="mb-3 mx-3" method="POST" action="{{ route('hwu.postResetPassword.HWU') }}">
                        @csrf
