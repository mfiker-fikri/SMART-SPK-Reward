    ...
    <div class="row mt-3">
        ...
        <div class="col-xxl">
            ...
            <div class="card mx-4">
                ...
                <!-- Form Create Add Team Assessment New -->
                <div class="card-body py-xl-5 py-sm-5 px-xl-5">

                    <form id="formCreateTANew" class="mx-2" method="POST" action="{{ URL::to('sdm/kepala-subbagian-penghargaan-disiplin-dan-pensiun/manage/team-assessment/create/post') }}" enctype="multipart/form-data">
                        @csrf
                        <!-- Full Name -->
                        ...
                        <div class="mt-4 d-flex justify-content-end">
                            <div class="justify-content-between">
                                <a class="btn btn-secondary btn-lg" href="{{ URL::to('sdm/kepala-subbagian-penghargaan-disiplin-dan-pensiun/manage/team-assessment') }}" role="button" style="color: black">
