...
class CreateFinalResultRewardInovationTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('final_result_reward_innovation', function (Blueprint $table) {
            $table->uuid('id')->primary();
            //
            $table->uuid('reward_innovation_id');
            $table->foreign('reward_innovation_id')->references('id')->on('reward_innovation')->onDelete('cascade');
            //
