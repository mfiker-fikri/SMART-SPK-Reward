...
@section('js_footer')
    ...
    $(document).ready(function() {
        $('#category').select2({
            // ajax: {
            //     url: "{{ url('hrd/select/categories/parameters') }}",
            //     type: "get",
            //     dataType: 'json',
            //     delay: 1000,
        ...
        $('#category').change(function() {
            $('#criteria').empty();
            $('#valueQuality').val(null);
            let categoriesId = $(this).val();
            ...
            if (categoriesId != null) {
                ...
                $criteria.select2({
                    ajax: {
                        ...
                        // },
                        url: "{{ route('hrd.getSelectCriterias.Parameters.HRD') }}?categoriesId=" + categoriesId,
                        type: "GET",
                        dataType: 'json',
                        delay: 250, 
        ...
        $('#criteria').change(function() {
            $('#valueQuality').empty();
            let criteriasId = $(this).val();
            // console.log(criteriasId);
            if (criteriasId != null) {
                // $('#valueQuality').select2({});
                $.ajax({
                    url: "{{ route('hrd.getInputValueQuality.Parameters.HRD') }}?criteriasId=" + criteriasId,
                    type: "GET",
                    dataType: 'json',
                    delay: 250, 
                    success: function(data) {
                        console.log(data);
                        // $('#valueQuality').val(data.value_quality);
                        // document.getElementById('valueQuality').html=data;
                        // $('#valueQuality').html(data);
                        // document.getElementById('valueQuality').innerHTML=data.value;
                        // var attend = parseInt(data[0]);
                        $('#valueQuality').val(data[0].value_quality);
...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row mt-3">
        ...
        <div class="col-xxl">
            ...
            <!-- Card Add Parameters New -->
            <div class="card mx-4">

                <!-- Form Create Add Parameters New Title -->
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">Tambah Parameter Baru</h5>
                </div>
                <!--/ Form Create Add Parameters New Title -->

                <!-- Form Create Add Parameters New -->
                <div class="card-body py-xl-5 py-sm-5 px-xl-5">

                    <form id="formCreateParametersNew" class="mx-2" method="POST" action="{{ route('hrd.postManageParameters.Create.HRD') }}">
                        @csrf
                        <!-- Categories -->
                        <div class="mb-3 row {{ $errors->has('categories') ? 'is-invalid' : '' }}">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group input-group-merge">
                                    ...
                                    <select class="form-select px-lg-1 px-2 {{ $errors->has('categories') ? 'is-invalid' : '' }}" id="category" 
                        ...
                        <div class="mb-3 row {{ $errors->has('criterias') ? 'is-invalid' : '' }}">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group input-group-merge">
                                    ...
                                    <select class="form-control px-lg-1 px-2 {{ $errors->has('criterias') ? 'is-invalid' : '' }}" id="criteria"
                                        ...
                                        data-dependent="category">
                                        <option value="" disabled selected>--Pilih Kriteria--</option>
                                        {{-- @foreach ($criteria as $c)
                                            <option value="{{ $c->id }}">{{ $c->criteria }}</option>
                                        @endforeach --}}
                                    </select>
                                </div>
                        ...
                        <div class="mb-3 row {{ $errors->has('value_quality') ? 'is-invalid' : '' }}">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="number" class="form-control px-lg-1 px-2 {{ $errors->has('value_quality') ? 'is-invalid' : '' }}" id="valueQuality"
                                        name="value_quality" placeholder="*Bobot Nilai"
                                        autofocus autocomplete required value="{{ old('value_quality') }}"
                                        aria-invalid="true" aria-describedby="value_quality" 
                                        data-val="true" min="0" max="100">
                                </div>
                        ...
                        <!-- Parameters -->
                        <div class="mb-3 row {{ $errors->has('parameters') ? 'is-invalid' : '' }}">
                            <label for="parameters" class="text-wrap col-sm-3 col-form-label">Parameter</label>
                            <div class="col-sm-9">
                                <div class="input-group input-group-merge">
                                    <span id="parameters" class="input-group-text">
                                        <i class="fa-solid fa-user"></i>
                                    </span>
                                    <textarea type="text" class="form-control px-lg-1 px-2 {{ $errors->has('parameters') ? 'is-invalid' : '' }}" id="parametersEditor"
                                ...
                                <div class="d-flex flex-column">
                                    <div id="parametersHelp" class="form-text">We'll never share your email with anyone else.</div>
                                    <!-- Error Parameters -->
                        ...
                        <!-- Grade -->
                        <div class="mb-3 row {{ $errors->has('grades') ? 'is-invalid' : '' }}">
                            <label for="grades" class="text-wrap col-sm-3 col-form-label">Nilai</label>
                            <div class="col-sm-9">
                                <div class="input-group input-group-merge">
                                    <span id="grades" class="input-group-text">
                                        <i class="fa-solid fa-user"></i>
                                    </span>
                                    <input type="number" class="form-control px-lg-1 px-2 {{ $errors->has('grades') ? 'is-invalid' : '' }}" id="grades"
                                        name="grades" placeholder="*Nilai"
                                        autofocus autocomplete required value="{{ old('grades') }}"
                                        aria-invalid="true" aria-describedby="grades" 
                                        data-val="true" min="1" max="4">
                                </div>

                                <div class="d-flex flex-column">
                                    <div id="gradesHelp" class="form-text">We'll never share your email with anyone else.</div>
                                    <!-- Error Grade -->
                        ...
                        <div class="d-flex justify-content-end">
                            <div class="justify-content-between">
                                <a class="btn btn-secondary btn-lg" href="{{ URL::to('hrd/manage/parameters') }}" role="button" style="color: black">
