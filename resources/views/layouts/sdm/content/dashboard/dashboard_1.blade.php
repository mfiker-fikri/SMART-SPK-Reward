                    ...
                    <div class="card mb-2 visible shadow-lg d-flex justify-content-center align-self-center cardInovation">
                        <div class="d-flex justify-content-center align-self-center cardFormInovation">
                            ...
                            @else
                                @if (
                                    (
                                        ($timerInovasi->status_open_signature_human_resource_1 == 0 && $timerInovasi->date_time_open_signature_human_resource_1 >= \Carbon\Carbon::now()->toDateTimeString()  ) && ($timerInovasi->status_expired_signature_human_resource_1 == 0 && \Carbon\Carbon::now()->toDateTimeString() <= $timerInovasi->date_time_expired_signature_human_resource_1 )
                                    )
                                    ||
                                    (
                                        ($timerInovasi->status_open_signature_human_resource_1 == 0 && $timerInovasi->date_time_open_signature_human_resource_1 >= \Carbon\Carbon::now()->toDateTimeString() ) && ($timerInovasi->status_expired_signature_human_resource_1 == 1 && \Carbon\Carbon::now()->toDateTimeString() <= $timerInovasi->date_time_expired_signature_human_resource_1 )
                                    )
                                )
                                ...
                                @elseif (
                                    (
                                                ($timerInovasi->status_open_signature_human_resource_1 == 1
                                            && ($timerInovasi->date_time_open_signature_human_resource_1 > \Carbon\Carbon::now()->toDateTimeString()  || $timerInovasi->date_time_open_signature_human_resource_1 == \Carbon\Carbon::now()->toDateTimeString() ))
                                ...
                                <div class="container-fluid swiper1">
                                    <div class="openTimerCountDown swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            ...
                                            <div class="wrap-countdown countdown-TA-inovation" data-expire="{{ \Carbon\Carbon::parse($timerInovasi->date_time_open_signature_human_resource_1)->toDateTimeString() }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                @elseif (
                                    (
                                            (
                                                    ($timerInovasi->status_open_signature_human_resource_1 == 1 && (\Carbon\Carbon::now()->toDateTimeString() > $timerInovasi->date_time_open_signature_human_resource_1  || \Carbon\Carbon::now()->toDateTimeString() == $timerInovasi->date_time_open_signature_human_resource_1 ) )
                                                &&  ($timerInovasi->status_expired_signature_human_resource_1 == 1 && \Carbon\Carbon::now()->toDateTimeString() <= $timerInovasi->date_time_expired_signature_human_resource_1 )
                                            )
                                        ||  (
                                                    ($timerInovasi->status_open_signature_human_resource_1 == 1 && (\Carbon\Carbon::now()->toDateTimeString() > $timerInovasi->date_time_open_signature_human_resource_1 || \Carbon\Carbon::now()->toDateTimeString() == $timerInovasi->date_time_open_signature_human_resource_1))
                                    ...
                                    (
                                            (
                                                    ($timerInovasi->status_open_signature_human_resource_1 == 0 && (\Carbon\Carbon::now()->toDateTimeString() > $timerInovasi->date_time_open_signature_human_resource_1 || \Carbon\Carbon::now()->toDateTimeString() == $timerInovasi->date_time_open_signature_human_resource_1))
                                                &&  ($timerInovasi->status_expired_signature_human_resource_1 == 1 && \Carbon\Carbon::now()->toDateTimeString() <= $timerInovasi->date_time_expired_signature_human_resource_1)
                                            )
                                        || (
                                                    ($timerInovasi->status_open_signature_human_resource_1 == 0 && (\Carbon\Carbon::now()->toDateTimeString() > $timerInovasi->date_time_open_signature_human_resource_1 || \Carbon\Carbon::now()->toDateTimeString() == $timerInovasi->date_time_open_signature_human_resource_1))
                                ...
                                <div class="container-fluid swiper1_1">
                                    <div class="openTimerCountDown swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            ...
                                            <div class="wrap-countdown countdown-TA-inovation-closed" data-expire="{{ \Carbon\Carbon::parse($timerInovasi->date_time_expired_signature_human_resource_1)->toDateTimeString() }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                @elseif (
                                    (
                                            ( ($timerInovasi->status_open_signature_human_resource_1 == 1 && \Carbon\Carbon::now()->toDateTimeString() >= $timerInovasi->date_time_open_signature_human_resource_1) && ($timerInovasi->status_expired_signature_human_resource_1 == 1 && \Carbon\Carbon::now()->toDateTimeString() >= $timerInovasi->date_time_expired_signature_human_resource_1) )
                                        ||  ( ($timerInovasi->status_open_signature_human_resource_1 == 1 && \Carbon\Carbon::now()->toDateTimeString() >= $timerInovasi->date_time_open_signature_human_resource_1) && ($timerInovasi->status_expired_signature_human_resource_1 == 0 && \Carbon\Carbon::now()->toDateTimeString() >= $timerInovasi->date_time_expired_signature_human_resource_1) )
                                    )
                                    ||
                                    (
                                            ( ($timerInovasi->status_open_signature_human_resource_1 == 0 && \Carbon\Carbon::now()->toDateTimeString() >= $timerInovasi->date_time_open_signature_human_resource_1) && ($timerInovasi->status_expired_signature_human_resource_1 == 1 && \Carbon\Carbon::now()->toDateTimeString() >= $timerInovasi->date_time_expired_signature_human_resource_1) )
                                        || ( ($timerInovasi->status_open_signature_human_resource_1 == 0 && \Carbon\Carbon::now()->toDateTimeString() >= $timerInovasi->date_time_open_signature_human_resource_1) && ($timerInovasi->status_expired_signature_human_resource_1 == 0 && \Carbon\Carbon::now()->toDateTimeString() >= $timerInovasi->date_time_expired_signature_human_resource_1) )
                                    )
                                )
                    ...
                    <div class="card mb-2 visible shadow-lg d-flex justify-content-center align-self-center cardRepresentative">
                        <div class="d-flex justify-content-center align-self-center cardFormRepresentative">
                            ...
                            @else
                                @if (
                                    (
                                        ($timerTeladan->status_open_signature_human_resource_1 == 0 && $timerTeladan->date_time_open_signature_human_resource_1 >= \Carbon\Carbon::now()->toDateTimeString() ) && ($timerTeladan->status_expired_signature_human_resource_1 == 0 && \Carbon\Carbon::now()->toDateTimeString() <= $timerTeladan->date_time_expired_signature_human_resource_1)
                                    )
                                    ||
                                    (
                                        ($timerTeladan->status_open_signature_human_resource_1 == 0 && $timerTeladan->date_time_open_signature_human_resource_1 >= \Carbon\Carbon::now()->toDateTimeString()) && ($timerTeladan->status_expired_signature_human_resource_1 == 1 && \Carbon\Carbon::now()->toDateTimeString() <= $timerTeladan->date_time_expired_signature_human_resource_1)
                                    )
                                )
                                <div class="container-fluid">
                                    <div class="titleCountDownNonActive">
                                ...
                                @elseif (
                                    (
                                                ($timerTeladan->status_open_signature_human_resource_1 == 1
                                            && ($timerTeladan->date_time_open_signature_human_resource_1 > \Carbon\Carbon::now()->toDateTimeString() || $timerTeladan->date_time_open_signature_human_resource_1 == \Carbon\Carbon::now()->toDateTimeString()))
                                ...
                                <div class="container-fluid swiper1">
                                    <div class="openTimerCountDown swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            ...
                                            <div class="wrap-countdown countdown-TA-representative" data-expire="{{ Carbon\Carbon::parse($timerTeladan->date_time_open_signature_human_resource_1)->toDateTimeString() }}">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                @elseif (
                                    (
                                            (
                                                    ($timerTeladan->status_open_signature_human_resource_1 == 1 && (\Carbon\Carbon::now()->toDateTimeString() > $timerTeladan->date_time_open_signature_human_resource_1 || \Carbon\Carbon::now()->toDateTimeString() == $timerTeladan->date_time_open_signature_human_resource_1) )
                                                &&  ($timerTeladan->status_expired_signature_human_resource_1 == 1 && \Carbon\Carbon::now()->toDateTimeString() <= $timerTeladan->date_time_expired_signature_human_resource_1)
                                            )
                                        ||  (
                                                    ($timerTeladan->status_open_signature_human_resource_1 == 1 && (\Carbon\Carbon::now()->toDateTimeString() > $timerTeladan->date_time_open_signature_human_resource_1 || \Carbon\Carbon::now()->toDateTimeString() == $timerTeladan->date_time_open_signature_human_resource_1))
                                    ...
                                    (
                                            (
                                                    ($timerTeladan->status_open_signature_human_resource_1 == 0 && (\Carbon\Carbon::now()->toDateTimeString() > $timerTeladan->date_time_open_signature_human_resource_1 || \Carbon\Carbon::now()->toDateTimeString() == $timerTeladan->date_time_open_signature_human_resource_1))
                                                &&  ($timerTeladan->status_expired_signature_human_resource_1 == 1 && \Carbon\Carbon::now()->toDateTimeString() <= $timerTeladan->date_time_expired_signature_human_resource_1)
                                            )
                                        || (
                                                    ($timerTeladan->status_open_signature_human_resource_1 == 0 && (\Carbon\Carbon::now()->toDateTimeString() > $timerTeladan->date_time_open_signature_human_resource_1 || \Carbon\Carbon::now()->toDateTimeString() == $timerTeladan->date_time_open_signature_human_resource_1))
                                ...
                                <div class="container-fluid swiper1_1">
                                    <div class="openTimerCountDown swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            ...
                                            <div class="wrap-countdown countdown-TA-representative-closed" data-expire="{{ \Carbon\Carbon::parse($timerTeladan->date_time_expired_signature_human_resource_1)->toDateTimeString() }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                @elseif (
                                    (
                                            ( ($timerTeladan->status_open_signature_human_resource_1 == 1 && \Carbon\Carbon::now()->toDateTimeString() >= $timerTeladan->date_time_open_signature_human_resource_1) && ($timerTeladan->status_expired_signature_human_resource_1 == 1 && \Carbon\Carbon::now()->toDateTimeString() >= $timerTeladan->date_time_expired_signature_human_resource_1) )
                                        ||  ( ($timerTeladan->status_open_signature_human_resource_1 == 1 && \Carbon\Carbon::now()->toDateTimeString() >= $timerTeladan->date_time_open_signature_human_resource_1) && ($timerTeladan->status_expired_signature_human_resource_1 == 0 && \Carbon\Carbon::now()->toDateTimeString() >= $timerTeladan->date_time_expired_signature_human_resource_1) )
                                    )
                                    ||
                                    (
                                            ( ($timerTeladan->status_open_signature_human_resource_1 == 0 && \Carbon\Carbon::now()->toDateTimeString() >= $timerTeladan->date_time_open_signature_human_resource_1) && ($timerTeladan->status_expired_signature_human_resource_1 == 1 && \Carbon\Carbon::now()->toDateTimeString() >= $timerTeladan->date_time_expired_signature_human_resource_1) )
                                        || ( ($timerTeladan->status_open_signature_human_resource_1 == 0 && \Carbon\Carbon::now()->toDateTimeString() >= $timerTeladan->date_time_open_signature_human_resource_1) && ($timerTeladan->status_expired_signature_human_resource_1 == 0 && \Carbon\Carbon::now()->toDateTimeString() >= $timerTeladan->date_time_expired_signature_human_resource_1) )
                                    )
                                )
