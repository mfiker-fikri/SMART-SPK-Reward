                ...
                <div class="card-body py-xl-5 py-sm-5 px-xl-5">
                    ...
                    <form id="formViewCriterias" class="mx-2" method="POST" action="#">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group input-group-merge {{ $errors->has('criterias') ? 'is-invalid' : '' }}">
                                    ...
                                    <input type="text" class="form-control px-lg-1 px-2 {{ $errors->has('criterias') ? 'is-invalid' : '' }}" id="criterias"
                                        ...
                                        autofocus autocomplete required
                                        value="{{ old('criterias', $parameter->criterias->criteria) }}"
                        ...
                        <div class="mb-3 row {{ $errors->has('parameter') ? 'is-invalid' : '' }}">
                            <label for="parameter" class="text-wrap col-sm-3 col-form-label">Parameter</label>
                            <div class="col-sm-9">
                                <div class="input-group input-group-merge {{ $errors->has('parameter') ? 'is-invalid' : '' }}">
                                    <span id="parameter" class="input-group-text">
                                        {{-- <box-icon name='slider-alt'></box-icon> --}}
                                        <i class="fa-solid fa-sliders" style="color: #000000;"></i>
                                    </span>
                                    {{-- <input type="text" class="form-control px-lg-1 px-2 {{ $errors->has('parameter') ? 'is-invalid' : '' }}" id="parameter"
                                        name="parameter" placeholder="*Parameter"
                                        autofocus autocomplete required
                                        value="{{ old('parameter', $parameter->parameter) }}"
                                        aria-invalid="true" aria-describedby="parameter"
                                        data-val="true" readonly disabled /> --}}
                                    <textarea type="text" class="form-control px-lg-1 px-2 {{ $errors->has('parameter') ? 'is-invalid' : '' }}" id="parameter"
                                        name="parameter" placeholder="*Parameter"
                                        autofocus autocomplete required
                                        value="{{ old('parameter', $parameter->parameter) }}"
                                        aria-invalid="true" aria-describedby="parameter"
                                        data-val="true" readonly disabled rows="10" cols="50"> {{ old('parameter', $parameter->parameter) }} </textarea>
                                </div>
                        ...
                        <div class="d-flex justify-content-end">
                            <div class="justify-content-between">
                                <a class="btn btn-secondary btn-lg" href="{{ URL::to('sdm/kepala-subbagian-penghargaan-disiplin-dan-pensiun/manage/parameters') }}" role="button" style="color: black">
