                ...
                <div class="tab-pane fade show {{ (request()->is('admin/profile')) ? 'active' : '' }}" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                    ...
                    <div class="card my-4">
                        ...
                        <div class="card-body py-md-4 py-4 mx-4 mx-4">
                                    ...
                                    <div class="modal fade" id="changePhoto" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <!-- Form Change Photo -->
                                                <form id="formPhotoUpdate" class="mb-3" method="POST" action="{{ URL::to('admin/image/upload') }}" enctype="multipart/form-data">
                                                    @csrf
                            ...
                            <form id="formProfileUpdate" class="mx-3 my-3" method="POST" action="{{ URL::to('admin/profile/update') }}">
                                @csrf
                                <!-- Full Name -->
                ...
                <div class="tab-pane fade" id="pills-changePassword" role="tabpanel" aria-labelledby="pills-changePassword-tab">
                    ...
                    <div class="card my-4">
                        ...
                        <div class="card-body py-md-4 py-4 mx-4 mx-4">
                            ...
                            <form id="formChangePassword" class="mx-3 my-3" method="POST" action="{{ URL::to('admin/profile/change-password') }}">
                                @csrf
