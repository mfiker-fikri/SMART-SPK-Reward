                    ...
                    <td align="center" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <div class="app-brand justify-content-center">
                            <span class="app-brand-logo demo">
                                <a href="{{ URL::to('/admin') }}" style="display: inline-block; cursor: pointer;" onclick="return false">
                            ...
                            <tr>
                                <td align="center" width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <table align="center" width="80%" cellpadding="0" cellspacing="0" style="margin-bottom: 2em;">
                                        <tr>
                                            <td align="center" width="100%" cellpadding="0" cellspacing="0">
                                                <p style="font-size: 14px;">{{ $greetings }}, {{ $nameAdmin->full_name }}</p>
                                                <p style="font-size: 14px;">
                                                    ...
                                                    Ada permintaan untuk mengubah kata sandi Anda!
                                                    Jika Anda tidak membuat permintaan ini, harap abaikan email ini.
                                                    Jika tidak, <b> silakan klik tombol </b> di bawah ini untuk mengubah kata sandi Anda:
                                                </p>

                                                <div class="my-5 my-3 my-3 d-flex flex-row justify-content-center" style="margin: 2em 0;">
                                                    <a class="button-primary" target="_blank" href="{{ URL::to('admin/reset-password/'.$token) }}">Reset Password Saya</a>
                                                ...
                                                <p style="font-size: 14px;">
                                                    ...
                                                    Setelah 5 menit, Anda harus mengirimkan permintaan pengaturan ulang kata sandi baru.
                                                </p>
                                            </td>
                                        </tr>
                                    </table>
