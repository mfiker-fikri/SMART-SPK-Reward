            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="app-brand justify-content-center">
                        <a href="{{ URL::to('/penilai/forgot-password') }}" class="app-brand-link gap-2">
                    ...
                    <form id="formTAForgotPassword" class="mb-3 mx-3" method="POST" action="{{ route('penilai.postForgetPassword.Penilai') }}">
                        {{ csrf_field() }}
                    ...
                    <div class="mb-3 text-center">
                        <a class="btn btn-primary shadow-none d-grid w-15 h-15 d-inline-flex align-items-center justify-content-center" href="{{ URL::to('/penilai') }}" role="button" style="background-color: transparent !important; border-color: transparent !important">
