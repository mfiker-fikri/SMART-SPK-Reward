                    ...
                    <td align="center" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <div class="app-brand justify-content-center">
                            <span class="app-brand-logo demo">
                                <a href="{{ URL::to('/headworkunit') }}" style="display: inline-block; cursor: pointer;" onclick="return false">
                                        ...
                                        <tr>
                                            <td align="center" width="100%" cellpadding="0" cellspacing="0">
                                                ...
                                                <div class="my-5 my-3 my-3 d-flex flex-row justify-content-center" style="margin: 2em 0;">
                                                    <a class="button-primary" target="_blank" href="{{ URL::to('headworkunit/reset-password/'.$token) }}">Reset My Password</a>
                                                    {{-- <a href="{{ URL::to('headworkunit/reset-password/'.$token) }}" class="btn btn-primary btn-lg" role="button">Reset My Password</a> --}}
                                                </div>
