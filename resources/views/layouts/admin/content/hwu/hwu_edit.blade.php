                ...
                <div class="tab-pane fade show {{ (request()->is('admin/manage/ksk/edit*')) ? 'active' : '' }}" id="pills-editAdmin" role="tabpanel" aria-labelledby="pills-editAdmin-tab">
                    ...
                    <div class="card my-4">
                        ...
                        <div class="card-body py-xl-5 py-sm-5 px-xl-5">
                            ...
                            <form id="formEditHWU" class="mx-2" method="POST" action="{{ route('admin.postManageHWUId.Update.Admin', $hwu->id) }}" enctype="multipart/form-data">
                                @csrf
                                <!-- Full Name -->
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control {{ $errors->has('full_name') ? 'is-invalid' : '' }}" id="full_name"
                                                ...
                                                autofocus autocomplete required value="{{ old('full_name', $hwu->full_name) }}"
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control {{ $errors->has('username') ? 'is-invalid' : '' }}" id="username"
                                                ...
                                                autofocus autocomplete required value="{{ old('username',$hwu->username) }}"
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            ...
                                            <input type="email" class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" id="email"
                                                ...
                                                autofocus autocomplete required value="{{ old('email', $hwu->email) }}"
                ...
                <div class="tab-pane fade" id="pills-changePassword" role="tabpanel" aria-labelledby="pills-changePassword-tab">
                    ...
                    <div class="card my-4">
                        ...
                        <div class="card-body py-md-4 py-4 mx-4 mx-4">
                            ...
                            <form id="formChangePassword" class="mb-3" method="POST" action="{{ route('admin.postManageHWUId.UpdateChangePassword.Admin', $hwu->id) }}">
                                @csrf
