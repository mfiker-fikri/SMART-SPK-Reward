            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="app-brand justify-content-center">
                        <a href="{{ URL::to('/admin') }}" class="app-brand-link gap-2">
                    ...
                    <!-- Form Login -->
                    <form id="formAdminLogin" class="mb-3 mx-3" method="POST" action="{{ URL::to('/admin') }}" >
                        @csrf
                        ...
                        <div class="mb-3 form-password-toggle">
                            <div class="d-flex justify-content-between">
                                ...
                                <a href="{{ URL::to('/admin/forgot-password') }}">
                        ...
                        {{-- <!-- Recaptcha -->
                        <div class="mb-3 ">
                            <label for="g-recaptcha-response" class="form-label">Recaptcha</label>
                            <div class="col-md-10">
                                {!! htmlFormSnippet() !!}
                            </div>
                            <!-- Error Username -->
                        ...
                        <!-- Error Auth, Success Login and Success Logout -->
                        ...
                        {{-- @if( ($errors->any() && $retries > 0 ) || $retries <= 0)
                        <div class="d-flex flex-row alert alert-danger alert-dismissible fade show" role="alert">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-exclamation-triangle-fill flex-shrink-0 me-2" viewBox="0 0 16 16" role="img" aria-label="Warning:">
                                <path d="M8.982 1.566a1.13 1.13 0 0 0-1.96 0L.165 13.233c-.457.778.091 1.767.98 1.767h13.713c.889 0 1.438-.99.98-1.767L8.982 1.566zM8 5c.535 0 .954.462.9.995l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 5.995A.905.905 0 0 1 8 5zm.002 6a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/>
                            </svg>
                            <div class="d-flex flex-md-row">
                                <p>
                                    ...
                                    <strong><b>  Remaining {{ $retries }} attempt.   </b></strong>
                                    @elseif( $retries <= 0 )
                                    <strong><b>  Please Try Again After {{ $second }} seconds.   </b></strong>
                                    @endif
                                </p>
                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
                                </button>
