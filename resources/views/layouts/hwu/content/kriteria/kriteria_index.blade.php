...
@section('js_footer')
    ...
    $(document).ready(function () {
        var table = $('#data-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ url('hrd/manage/criterias/list') }}",
            columns: [
                ...
                <div class="container-fluid">
                    ...
                    <div class="py-3 d-flex flex-row justify-content-start">
                        <div class="mx-1 mx-1 mx-1">
                            <a class="btn btn-primary btn-lg" href="{{ URL::to('hrd/manage/criterias/create') }}" role="button">
                                <i class="fa-solid fa-plus mx-auto me-1"></i> Create Criteria
                            </a>
                        </div>
                    </div>
                    <!--/ Button Create Kriteria -->
