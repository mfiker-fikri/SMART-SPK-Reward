        ...
        <div class="col-xxl">
            ...
            <div class="card mx-4">
                ...
                <div class="card-body py-xl-5 py-sm-5 px-xl-5">
                    ...
                    <form id="formUpdateCriterias" class="mx-2" method="POST" action="{{ route('hrd.postManageCriteriasId.Update.HRD',$criteria->id) }}">
                        @csrf
                        <!-- Categories -->
                        ...
                        <div class="d-flex justify-content-end">
                            <div class="justify-content-between">
                                <a class="btn btn-secondary btn-lg" href="{{ URL::to('hrd/manage/criterias') }}" role="button" style="color: black">
                                    <i class="fa-solid fa-arrow-left mx-auto me-1"></i> Kembali
                                </a>
                                <button type="reset" class="btn btn-warning btn-lg" style="color: black" id="reset">
